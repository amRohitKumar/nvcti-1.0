...
import EventFormPage from "./client/event-form/event-form.page";
...
export {
  LogIn, Register, Error, ClientDashboard, AdminDashboard, EventDetails, StatusPage, EventFormPage, CreateEvent, SharedLayoutClient,
  SharedLayoutAdmin,
  Home, About, Missions, Videos, Navbar
};
